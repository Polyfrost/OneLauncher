...
const ARGS_MAP = { 'debug':'{"getPackageVersion":[],"isInDev":[],"getType":[],"getGitCommitHash":[],"getArch":[],"getBuildTimestamp":[],"openDevTools":[],"getPlatform":[],"getFamily":[],"getOsVersion":[],"getLocale":[]}', 'folders':'{"openCluster":["folder_name"],"fromCluster":["folder_name"]}', 'oneclient':'{"getBundlesFor":["cluster_id"],"getVersions":[],"getClustersGroupedByMajor":[]}', 'events':'{"message":["event"],"process":["event"],"ingress":["event"]}', 'core':'{"installModpack":["modpack","cluster_id"],"removeCape":["access_token"],"killProcess":["pid"],"getLogByName":["id","name"],"getGlobalProfile":[],"removeCluster":["id"],"getUsersFromAuthor":["provider","author"],"getPackage":["provider","slug"],"getUser":["uuid"],"getPackageVersions":["provider","slug","mc_version","loader","offset","limit"],"getRunningProcesses":[],"readSettings":[],"getPackageBody":["provider","body"],"removePackage":["cluster_id","package_hash"],"setDiscordRPCMessage":["message"],"searchPackages":["provider","query"],"getMultiplePackages":["provider","slugs"],"updateClusterById":["id","request"],"writeSettings":["setting"],"isClusterRunning":["cluster_id"],"getProfileOrDefault":["name"],"getGameVersions":[],"getClusters":[],"getLogs":["id"],"updateClusterProfile":["name","profile"],"removeUser":["uuid"],"getDefaultUser":["fallback"],"setDefaultUser":["uuid"],"getScreenshots":["id"],"getLoadersForVersion":["mc_version"],"createCluster":["options"],"createSettingsProfile":["name"],"getWorlds":["id"],"openMsaLogin":[],"getLinkedPackages":["cluster_id"],"fetchMinecraftProfile":["uuid"],"uploadSkinBytes":["access_token","skin_data","image_format","skin_variant"],"downloadExternalPackage":["package","cluster_id","force","skip_compatibility"],"changeCape":["access_token","cape_uuid"],"getUsers":[],"open":["input"],"fetchLoggedInProfile":["access_token"],"convertUsernameUUID":["username_uuid"],"launchCluster":["id","uuid","search_for_java"],"downloadPackage":["provider","package_id","version_id","cluster_id","skip_compatibility"],"getRunningProcessesByClusterId":["cluster_id"],"changeSkin":["access_token","skin_url","skin_variant"],"getClusterById":["id"]}' }
