...
const ARGS_MAP = { 'core':'{"createCluster":["options"],"refreshAccount":["uuid"],"changeSkin":["access_token","skin_url","skin_variant"],"removeUser":["uuid"],"getClusterById":["id"],"getProcessLogTail":["id","max_lines"],"launchCluster":["id","uuid","search_for_java"],"syncCluster":["cluster_id"],"getLogByName":["id","name"],"getGlobalProfile":[],"getUsers":[],"openMsaLogin":[],"getPackage":["provider","slug"],"downloadExternalPackage":["package","cluster_id","force","skip_compatibility"],"getDefaultUser":["fallback"],"getClusters":[],"getLogs":["id"],"getRunningProcesses":[],"refreshAccounts":[],"getPackageBody":["provider","body"],"changeCape":["access_token","cape_uuid"],"setClusterStage":["id","stage"],"readSettings":[],"getProfileOrDefault":["name"],"getLoadersForVersion":["mc_version"],"searchPackages":["provider","query"],"downloadPackage":["provider","package_id","version_id","cluster_id","skip_compatibility"],"removeCluster":["id"],"getMultiplePackages":["provider","slugs"],"getUsersFromAuthor":["provider","author"],"getLinkedPackages":["cluster_id"],"removePackage":["cluster_id","package_hash"],"getScreenshots":["id"],"installModpack":["modpack","cluster_id"],"fetchMinecraftProfile":["uuid"],"convertUsernameUUID":["username_uuid"],"setDiscordRPCMessage":["message"],"isClusterRunning":["cluster_id"],"createSettingsProfile":["name"],"getRunningProcessesByClusterId":["cluster_id"],"setDefaultUser":["uuid"],"getGameVersions":[],"getPackageVersions":["provider","slug","mc_version","loader","offset","limit"],"updateClusterById":["id","request"],"togglePackage":["cluster_id","package_hash"],"killProcess":["pid"],"updateClusterProfile":["name","profile"],"getUser":["uuid"],"writeSettings":["setting"],"uploadSkinBytes":["access_token","skin_data","image_format","skin_variant"],"open":["input"],"removeCape":["access_token"],"fetchLoggedInProfile":["access_token"],"getWorlds":["id"]}', 'folders':'{"fromCluster":["folder_name"],"openCluster":["folder_name"]}', 'debug':'{"getArch":[],"getOsVersion":[],"getGitCommitHash":[],"openDevTools":[],"getType":[],"getPackageVersion":[],"getLocale":[],"getBuildTimestamp":[],"isInDev":[],"getPlatform":[],"getFamily":[]}', 'events':'{"message":["event"],"process":["event"],"ingress":["event"]}', 'oneclient':'{"updateBundlePackages":["cluster_id"],"isBundleSyncing":[],"getClustersGroupedByMajor":[],"downloadPackageFromBundle":["package","cluster_id","bundle_name","skip_compatibility"],"extractBundleOverrides":["bundle_path","cluster_id"],"getVersions":[],"refreshArt":["path"],"cacheArt":["path"],"installUpdate":[],"checkForUpdate":[],"getBundlesFor":["cluster_id"]}' }
