...
const ARGS_MAP = { 'oneclient':'{"getBundlesFor":["cluster_id"],"getVersions":[],"getClustersGroupedByMajor":[]}', 'core':'{"installModpack":["modpack","cluster_id"],"uploadSkinBytes":["access_token","skin_data","image_format","skin_variant"],"changeCape":["access_token","cape_uuid"],"getWorlds":["id"],"removeCape":["access_token"],"getGlobalProfile":[],"launchCluster":["id","uuid"],"searchPackages":["provider","query"],"removeCluster":["id"],"getMultiplePackages":["provider","slugs"],"getClusters":[],"downloadPackage":["provider","package_id","version_id","cluster_id","skip_compatibility"],"downloadExternalPackage":["package","cluster_id","force","skip_compatibility"],"getPackage":["provider","slug"],"getPackageVersions":["provider","slug","mc_version","loader","offset","limit"],"getLogs":["id"],"setDefaultUser":["uuid"],"removeUser":["uuid"],"getProfileOrDefault":["name"],"getLinkedPackages":["cluster_id"],"getClusterById":["id"],"fetchLoggedInProfile":["access_token"],"writeSettings":["setting"],"readSettings":[],"getUser":["uuid"],"getScreenshots":["id"],"convertUsernameUUID":["username_uuid"],"isClusterRunning":["cluster_id"],"updateClusterById":["id","request"],"getGameVersions":[],"getLoadersForVersion":["mc_version"],"getDefaultUser":["fallback"],"openMsaLogin":[],"changeSkin":["access_token","skin_url","skin_variant"],"getUsersFromAuthor":["provider","author"],"setDiscordRPCMessage":["message"],"fetchMinecraftProfile":["uuid"],"updateClusterProfile":["name","profile"],"killProcess":["pid"],"getLogByName":["id","name"],"getPackageBody":["provider","body"],"open":["input"],"getRunningProcesses":[],"getUsers":[],"createSettingsProfile":["name"],"getRunningProcessesByClusterId":["cluster_id"],"createCluster":["options"]}', 'debug':'{"getPackageVersion":[],"getArch":[],"getType":[],"getBuildTimestamp":[],"getOsVersion":[],"isInDev":[],"openDevTools":[],"getLocale":[],"getGitCommitHash":[],"getPlatform":[],"getFamily":[]}', 'events':'{"ingress":["event"],"process":["event"],"message":["event"]}', 'folders':'{"fromCluster":["folder_name"],"openCluster":["folder_name"]}' }
