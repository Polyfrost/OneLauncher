...
const ARGS_MAP = { 'folders':'{"fromCluster":["folder_name"],"openCluster":["folder_name"]}', 'events':'{"ingress":["event"],"message":["event"],"process":["event"]}', 'oneclient':'{"openDevTools":[],"getClustersGroupedByMajor":[],"getBundlesFor":["cluster_id"]}', 'core':'{"createSettingsProfile":["name"],"launchCluster":["id","uuid"],"getScreenshots":["id"],"writeSettings":["setting"],"getPackageVersions":["provider","slug","mc_version","loader","offset","limit"],"searchPackages":["provider","query"],"changeCape":["access_token","cape_uuid"],"createCluster":["options"],"getLogByName":["id","name"],"getPackage":["provider","slug"],"downloadPackage":["provider","package_id","version_id","cluster_id","skip_compatibility"],"getMultiplePackages":["provider","slugs"],"getWorlds":["id"],"getClusterById":["id"],"getUsersFromAuthor":["provider","author"],"getPackageBody":["provider","body"],"getRunningProcesses":[],"getGlobalProfile":[],"getProfileOrDefault":["name"],"changeSkin":["access_token","skin_url","skin_variant"],"installModpack":["modpack","cluster_id"],"convertUsernameUUID":["username_uuid"],"getGameVersions":[],"fetchLoggedInProfile":["access_token"],"getUsers":[],"removeUser":["uuid"],"getClusters":[],"killProcess":["pid"],"removeCluster":["id"],"removeCape":["access_token"],"uploadSkinBytes":["access_token","skin_data","image_format","skin_variant"],"getRunningProcessesByClusterId":["cluster_id"],"openMsaLogin":[],"open":["input"],"readSettings":[],"updateClusterProfile":["name","profile"],"isClusterRunning":["cluster_id"],"getLoadersForVersion":["mc_version"],"getDefaultUser":["fallback"],"getLogs":["id"],"fetchMinecraftProfile":["uuid"],"getUser":["uuid"],"updateClusterById":["id","request"],"setDefaultUser":["uuid"],"getMods":["id"]}' }
