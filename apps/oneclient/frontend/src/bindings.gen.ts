...
const ARGS_MAP = { 'folders':'{"openCluster":["folder_name"],"fromCluster":["folder_name"]}', 'core':'{"convertUsernameUUID":["username_uuid"],"createCluster":["options"],"getClusters":[],"getGameVersions":[],"writeSettings":["setting"],"getLogByName":["id","name"],"getUsersFromAuthor":["provider","author"],"installModpack":["modpack","cluster_id"],"changeSkin":["access_token","skin_url","skin_variant"],"getPackageVersions":["provider","slug","mc_version","loader","offset","limit"],"changeCape":["access_token","cape_uuid"],"createSettingsProfile":["name"],"getUser":["uuid"],"readSettings":[],"fetchLoggedInProfile":["access_token"],"launchCluster":["id","uuid","search_for_java"],"getUsers":[],"downloadPackage":["provider","package_id","version_id","cluster_id","skip_compatibility"],"openMsaLogin":[],"getLogs":["id"],"removeUser":["uuid"],"getMultiplePackages":["provider","slugs"],"removeCape":["access_token"],"refreshAccount":["uuid"],"removeCluster":["id"],"getPackage":["provider","slug"],"syncCluster":["cluster_id"],"getLoadersForVersion":["mc_version"],"uploadSkinBytes":["access_token","skin_data","image_format","skin_variant"],"killProcess":["pid"],"setDefaultUser":["uuid"],"getPackageBody":["provider","body"],"getRunningProcesses":[],"open":["input"],"refreshAccounts":[],"searchPackages":["provider","query"],"downloadExternalPackage":["package","cluster_id","force","skip_compatibility"],"getWorlds":["id"],"setDiscordRPCMessage":["message"],"fetchMinecraftProfile":["uuid"],"getLinkedPackages":["cluster_id"],"isClusterRunning":["cluster_id"],"getDefaultUser":["fallback"],"getProfileOrDefault":["name"],"getRunningProcessesByClusterId":["cluster_id"],"getGlobalProfile":[],"getClusterById":["id"],"removePackage":["cluster_id","package_hash"],"togglePackage":["cluster_id","package_hash"],"setClusterStage":["id","stage"],"updateClusterById":["id","request"],"getScreenshots":["id"],"updateClusterProfile":["name","profile"]}', 'events':'{"ingress":["event"],"message":["event"],"process":["event"]}', 'debug':'{"openDevTools":[],"getArch":[],"getGitCommitHash":[],"getPackageVersion":[],"getLocale":[],"getPlatform":[],"getFamily":[],"isInDev":[],"getType":[],"getBuildTimestamp":[],"getOsVersion":[]}', 'oneclient':'{"checkForUpdate":[],"installUpdate":[],"extractBundleOverrides":["bundle_path","cluster_id"],"downloadPackageFromBundle":["package","cluster_id","bundle_name","skip_compatibility"],"getVersions":[],"getClustersGroupedByMajor":[],"updateBundlePackages":["cluster_id"],"isBundleSyncing":[],"getBundlesFor":["cluster_id"]}' }
