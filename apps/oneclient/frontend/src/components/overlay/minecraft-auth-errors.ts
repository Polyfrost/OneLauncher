export interface MinecraftAuthErrorInfo {
	errorCode: string;
	whatHappened: string;
	stepsToFix: Array<string>;
}

export const minecraftAuthErrors: Array<MinecraftAuthErrorInfo> = [
	{
		...
		stepsToFix: [
			'Go to the <a href="https://www.minecraft.net/en-us/login" target="_blank" rel="noopener noreferrer">Minecraft Login</a> page and sign in',
			'Follow the instructions to verify your age',
			'Once verified, try signing in again',
			'For additional help, visit <a href="https://support.xbox.com/en-GB/help/family-online-safety/online-safety/UK-age-verification" target="_blank" rel="noopener noreferrer">UK age verification on Xbox</a>',
		],
	},
	{
		...
		stepsToFix: [
			...
			'Visit <a href="https://www.minecraft.net/en-us/login" target="_blank" rel="noopener noreferrer">Minecraft Login</a> and sign in',
	...
	},
	{
		...
		stepsToFix: [
			...
			'Check <a href="https://www.xbox.com/en-US/regions" target="_blank" rel="noopener noreferrer">Xbox Availability</a> for supported regions',
		],
	},
	{
		...
		stepsToFix: [
			'Visit <a href="https://www.xbox.com" target="_blank" rel="noopener noreferrer">Xbox</a> and sign in',
	...
	},
	{
		...
		stepsToFix: [
			'Review the <a href="https://help.minecraft.net/hc/en-us/articles/4408968616077" target="_blank" rel="noopener noreferrer">Family Setup Guide</a>',
	...
	},
	{
		...
		stepsToFix: [
			'Visit <a href="https://support.xbox.com" target="_blank" rel="noopener noreferrer">Xbox Support</a> and review the enforcement details',
	...
	},
	{
		...
		stepsToFix: [
			'Have a guardian sign in to <a href="https://account.microsoft.com/family/" target="_blank" rel="noopener noreferrer">Microsoft Family</a>',
