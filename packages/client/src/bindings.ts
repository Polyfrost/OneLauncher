...
export const PROGRAM_INFO = {"launcher_version":"1.0.0-alpha.1","webview_version":"2.44.2","tauri_version":"2.0.0-rc.3","dev_build":true,"platform":"linux","arch":"64"} as const;
 ...
 */
export type ManagedPackage = { provider: Providers; id: string; uid: string | null; package_type: PackageType; title: string; description: string; body: string; main: string; versions: string[]; game_versions: string[]; loaders: Loader[]; icon_url: string | null; created: string; updated: string; client: PackageSide; server: PackageSide; downloads: number; followers: number; categories: string[]; optional_categories: string[] | null; license: License | null; author: Author }
/**
 * Universal metadata for any managed user from a Mod distribution platform.
 */
export type ManagedUser = { id: string; username: string; url?: string | null; avatar_url?: string | null; bio?: string | null }
/**
...
export type ProviderSearchResults = { provider: Providers; results: SearchResult[] }
/**
