...
create table setting_profiles (
	...
	constraint setting_profiles_java_versions_id_fk foreign key (java_id) references java_versions
);
...
create table clusters (
	...
	constraint clusters_cluster_groups_id_fk foreign key (group_id) references cluster_groups,
	constraint clusters_setting_profiles_name_fk foreign key (setting_profile_name) references setting_profiles
);