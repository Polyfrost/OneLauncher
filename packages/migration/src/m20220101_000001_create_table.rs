        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(JavaVersions::MajorVersion).integer().not_null())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(Packages::Hash).text().not_null().primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(SettingProfiles::Name).text().not_null().primary_key())
                    .col(ColumnDef::new(SettingProfiles::JavaId).integer().null())
                    .col(ColumnDef::new(SettingProfiles::Res).json().null())
                    .col(ColumnDef::new(SettingProfiles::ForceFullscreen).boolean().null())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Clusters::Stage).integer().not_null().default(0))
                    .col(ColumnDef::new(Clusters::CreatedAt).date_time().not_null().default(Utc::now()))
                    ...
                    .col(ColumnDef::new(Clusters::LinkedPackId).text().null())
                    .col(ColumnDef::new(Clusters::LinkedPackVersion).text().null())
                    .foreign_key(
                        ForeignKey::create()
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(ClusterPackages::ClusterId).integer().not_null())
                    .col(ColumnDef::new(ClusterPackages::PackageHash).text().not_null())
                    .primary_key(
                        Index::create()
