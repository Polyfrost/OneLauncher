...
pub use queries::{
    ...
    use_add_microsoft_account, use_add_offline_account, use_available_bundles,
    use_begin_microsoft_login, use_bundle_overrides, use_bundle_updates, use_bundles_with_status,
    use_cached_image, use_cancel_microsoft_login, use_changelog, use_cluster,
    ...
    use_current_account, use_default_account, use_discard_leftovers, use_finish_microsoft_login,
    use_game_profile, use_game_versions, use_global_analytics, use_java_majors, use_java_runtimes,
