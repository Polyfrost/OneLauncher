...
const SEARCH_INDEX: &[SearchItem] = &[
    ...
    SearchItem {
        ...
        title: "Reset a launcher setting to its default",
        description: "Every option on this page has its own reset button, next to its control.",
        keywords: &["reset", "default", "defaults", "restore", "revert", "clear", "launcher"],
        route: Route::SettingsLauncher {},
    },
    SearchItem {
        id: "appearance.reset",
        icon: IconType::RefreshCw01,
        title: "Reset an appearance setting to its default",
        description: "The parallax background and animations each have their own reset button.",
        keywords: &["reset", "default", "defaults", "restore", "revert", "clear", "appearance", "theme"],
        route: Route::SettingsAppearance {},
    },
    SearchItem {
        id: "apis.reset",
        icon: IconType::RefreshCw01,
        title: "Reset an API key or endpoint to its default",
        description: "Each key and endpoint has its own reset button, next to its field.",
        keywords: &["reset", "default", "defaults", "restore", "revert", "clear", "api", "apis", "keys", "endpoint"],
        route: Route::SettingsApis {},
    },
    SearchItem {
        id: "minecraft.reset",
        icon: IconType::RefreshCw01,
        title: "Reset a Minecraft setting to its default",
        description: "Every global game option has its own reset button, next to its control.",
        keywords: &["reset", "default", "defaults", "restore", "revert", "clear", "minecraft", "game", "profile", "global"],
        route: Route::SettingsMinecraft {},
    },
    SearchItem {
        id: "developer.reset",
        icon: IconType::RefreshCw01,
        title: "Reset a developer option to its default",
        description: "Each developer option has its own reset button, next to its control.",
        keywords: &["reset", "default", "defaults", "restore", "revert", "clear", "developer", "debug"],
        route: Route::SettingsDeveloper {},
    },
    SearchItem {
        id: "nav.accounts",
