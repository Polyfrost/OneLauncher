...
const SEARCH_INDEX: &[SearchItem] = &[
    ...
    SearchItem {
        ...
        title: "Reset launcher settings to defaults",
        description: "Put the launcher options back to their defaults, leaving the launcher folder alone.",
    ...
    SearchItem {
        ...
        description: "Put the parallax background and animations back to their defaults.",
    ...
    SearchItem {
        id: "apis.reset",
        icon: IconType::RefreshCw01,
        title: "Reset APIs to defaults",
        description: "Clear your API keys and go back to the endpoints OneClient ships with.",
    ...
    SearchItem {
        id: "minecraft.reset",
        icon: IconType::RefreshCw01,
        title: "Reset Minecraft settings to defaults",
        description: "Put the global game options back to their defaults.",
    ...
    SearchItem {
        id: "developer.reset",
        icon: IconType::RefreshCw01,
        title: "Reset developer options to defaults",
        description: "Put the developer options back to their defaults.",
