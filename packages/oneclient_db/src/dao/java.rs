...
pub async fn insert(
    ...
    sqlx::query_as!(
        JavaVersionRow,
        r#"
		INSERT INTO java_versions (absolute_path, major, version, vendor, os_arch, is_jdk)
		VALUES (?, ?, ?, ?, ?, ?)
		...
		RETURNING absolute_path, major, version, vendor, os_arch, is_jdk as "is_jdk: bool"
		"#,
        absolute_path,
        i64::from(major),
        version,
...
pub async fn get_by_path(
    ...
    let row = sqlx::query_as!(
        JavaVersionRow,
        r#"
        SELECT absolute_path, major, version, vendor, os_arch, is_jdk as "is_jdk: bool"
        FROM java_versions
        WHERE absolute_path = ?
        "#,
        absolute_path,
