...
#[doc(inline)]
pub use ser::{
	Formatter, Serializer, to_string, to_string_pretty, to_vec, to_vec_pretty, to_writer,
	to_writer_pretty,
};
...
pub mod ser {
	...
	static UTF8_ERROR: &str = "`serde_json` internally guarantees UTF8 and uses `String::from_utf8_unchecked`. \
