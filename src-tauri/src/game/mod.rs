...
pub fn init() -> TauriPlugin<tauri::Wry> {
	tauri::plugin::Builder::new("game")
		...
		.invoke_handler(tauri::generate_handler![launch_game, set_selected_client])
		.build()
}
...
#[tauri::command]
async fn set_selected_client(
	handle: tauri::AppHandle,
	state: tauri::State<'_, Mutex<GameManagerState>>,
	details: client::GameClientDetails,
) -> Result<(), String> {
