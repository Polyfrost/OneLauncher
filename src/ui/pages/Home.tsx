...
import { createInstance, getGroupedInstances, getInstancesWithManifests } from '../../bridge/game';
...
function InstanceCard(props: Core.InstanceWithManifest) {
	const navigate = useNavigate();
	...
	return (
		<div class="flex flex-col gap-y-4">
			...
			<div class="grid grid-cols-4 2xl:grid-cols-6 gap-4">
				<For each={props.instances}>{item => <InstanceCard {...item} />}</For>
			</div>
		</div>
	);
}
...
function HomePage() {
	const [instances, { refetch }] = createResource(getGroupedInstances);
